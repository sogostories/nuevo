...
const startTimes=[5,9,16,19,29,37,42,52.5,63,75,80.5,87.5,93,98,102,106,110,118,121.5,127,135,139,142,146.5,151.6,156.7,160.5,165,172,178,182];
...
const vocabulary = [
  ...
  { word: 'bunader', translation: 'bunads' },
  { word: 'Bunader', translation: 'bunads' },
  { word: 'både', translation: 'both' },
  /* D */
  { word: 'da', translation: 'then' },
  { word: 'dagen', translation: 'the day' },
  ...
  { word: 'korps', translation: 'marching bands' },
  ...
  { word: 'tiden', translation: 'the time' },
  ...
  /* U */
  { word: 'ulike', translation: 'different' },
  ...
  { word: 'virkelig', translation: 'truly' },
  /* Ø */
